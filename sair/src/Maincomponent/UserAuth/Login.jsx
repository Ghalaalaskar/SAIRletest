...
const existingUserQuery2 = await getDocs(query(collection(db, 'GDT'), where('ID', '==', ID)));
  ...
  const existingUserQuery1 = await getDocs(query(collection(db, 'GDT'), where('PhoneNumber', '==', Phonenumber)));
...
if(showDetailsFormAdmin===true){
  try {
    ...
    if (!querySnapshot.empty) {
      ...
      const newFields = { Fname: Fname, Lname: Lname, PhoneNumber:Phonenumber, ID:ID ,isDefaultPassword: false};
      if (user) {
...
{!showDetailsFormAdmin && !showDetailsFormStaff && (
      ...
      >
        ...
        <Form id='dynamicForm' onSubmit={handleSubmit}  className={l.formContainer}>
          {role === 'gdt'? (
      ...
      `}
            ...
            <input
              ...
              onChange={handleInputChange}
            />
            {missingFields.Fname && <p style={{ color: 'red', marginTop: '3px',fontSize:'14px' }}>{missingFields.Fname}</p>}
           </div>
           ...
           <div className={l.profileField}>
            <input
              ...
              onChange={handleInputChange}
            />
            {missingFields.Lname && <p style={{ color: 'red', marginTop: '3px',fontSize:'14px' }}>{missingFields.Lname}</p>}
            </div>
            ...
            <input
              ...
              onFocus={(e) => (e.target.placeholder = '')} // Clear placeholder on focus
              onBlur={(e) =>
                (e.target.placeholder = 'Enter your id')
              } // Restore placeholder on blur if empty
              onChange={handleInputChange}
            />
            {validationMessages.idError && <p style={{ color: 'red', marginTop: '3px' ,fontSize:'14px' }}>{validationMessages.idError}</p>}
            {missingFields.ID && <p style={{ color: 'red', marginTop: '3px',fontSize:'14px' }}>{missingFields.ID}</p>}
           </div>
           ...
           <div className={l.profileField}>
            ...
            {missingFields.Phonenumber && <p style={{ color: 'red', marginTop: '3px',fontSize:'14px' }}>{missingFields.Phonenumber}</p>}
           </div>

            <button className={s.submitButton} onClick={handleNext} type='button'>
            Next
          </button>
...
{ showDetailsFormAdmin && !showDetailsFormStaff && showPasswordDetails ?(
       ...
       <p style={{marginBottom: '20px', marginTop:'60px'}} //i add marginTop for the journey numbers
            ...
            <div style={{ position: 'relative' }} className={`${l.profileField} ${l.passwordContainer}`}>
            <input
            ...
            >
              <i className={showpassworde ? 'far fa-eye' : 'far fa-eye-slash'}></i>
            </span> 
            {missingFields['passworde'] && <p style={{ color: 'red' , marginTop: '3px',fontSize:'14px' }}>{missingFields['passworde']}</p>}
          ...
          <div  >
            <ul style={{ marginLeft: '30px',fontSize:'14px' }}>
              ...
              <li style={{ color: passwordRequirements.special ? '#059855' : 'red' , marginBottom:'15px'}}>
